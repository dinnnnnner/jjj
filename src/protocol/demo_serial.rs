...
impl RequestFrame {
    ...
    pub fn a2b_net_nodes_discovery() -> Self {
        Self {
            cmd: Command::A2BNetNodesDiscovery,
            payload: Vec::new(),
        }
    }
    ...
    pub fn start_acceleration_acquisition() -> Self {
        Self {
            cmd: Command::StartAccelerationAcquisition,
            payload: Vec::new(),
        }
    }
    ...
    pub fn stop_acceleration_acquisition() -> Self {
        Self {
            cmd: Command::StopAccelerationAcquisition,
            payload: Vec::new(),
        }
    }
